...
django_sprint3 — это Django-проект «из коробки»: настроенная структура, зависимости, готовность к миграциям и запуску.  
Проект может служить стартовой базой для блога, социальной сети, API-сервиса или любого веб-приложения на Django.
